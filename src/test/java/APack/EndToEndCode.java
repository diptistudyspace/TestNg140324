...
public class EndToEndCode {
	...
	public void TestOne() throws InterruptedException {
		...
		driver.findElement(By.name("email")).sendKeys("ashoksahoo40@gmail.com");
		...
		//conforming with success display message
		 ...
		 Assert.assertEquals(SuccessStatusText, "Your Account Has Been Created!");
		...
		//Clear quantity
		driver.findElement(By.xpath("//*[@id=\"content\"]/form/div/table/tbody/tr/td[4]/div/input"));	//...
